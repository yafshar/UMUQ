...
AC_DEFUN([AX_FLANN], [
  ...
  AM_COND_IF([HAVE_FLANN], [
      ...
      AC_DEFINE(HAVE_FLANN_FLANN_H, 1, [Define to 1 if you have the <flann/flann.h> header file.])
      AC_DEFINE(HAVE_LIBFLANN, 1, [Define to 1 if you have the `flann' library (-lflann).])
    ]
  )
