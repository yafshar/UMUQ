#ifndef UMUQ_NEIGHBORDISTANCETYPE_H
#define UMUQ_NEIGHBORDISTANCETYPE_H

namespace umuq
{

/*! \enum NeighborDistanceTypes
 * \ingroup Numerics_Module
 * 
 * \brief Nearest neighbors distance types which can be used in %UMUQ
 * 
 */
enum class NeighborDistanceTypes
{
...
#endif // UMUQ_NEIGHBORDISTANCETYPE
