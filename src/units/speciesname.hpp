 ...
 * \ingroup Species_Module
 * 
 * \brief Species in the periodic table and user defined species
 * 
 */
class species
{
  public:
     ...
     */
	inline SpeciesID getSpeciesID(std::string const &SpeciesName);
     ...
     * \return int Zero-based index uniquely labeling each defined standard species name.
     */
	inline int getSpeciesIndex(std::string const &SpeciesName);
     ...
     * \brief Get the speciesAttribute object
     * 
     * \param ID  Zero-based index uniquely labeling each defined standard               
     *            speciesName. \sa SpeciesID
     * 
     * \return speciesAttribute A speciesAttribute object
     */
	inline speciesAttribute getSpecies(SpeciesID const ID);
     ...
     * \return speciesAttribute  A speciesAttribute object
     */
	inline speciesAttribute getSpecies(std::string const &SpeciesName);
...
species::species()
{
	...
	speciesTable[static_cast<int>(SpeciesID::electron)] = std::move(speciesAttribute("electron", 0.00054858));
	...
	speciesTable[static_cast<int>(SpeciesID::Am)] = std::move(speciesAttribute("Am", 243.0));
	speciesTable[static_cast<int>(SpeciesID::Cm)] = std::move(speciesAttribute("Cm", 247.0));
	speciesTable[static_cast<int>(SpeciesID::Bk)] = std::move(speciesAttribute("Bk", 247.0));
	speciesTable[static_cast<int>(SpeciesID::Cf)] = std::move(speciesAttribute("Cf", 251.0));
	speciesTable[static_cast<int>(SpeciesID::Es)] = std::move(speciesAttribute("Es", 252.0));
	speciesTable[static_cast<int>(SpeciesID::Fm)] = std::move(speciesAttribute("Fm", 257.0));
	speciesTable[static_cast<int>(SpeciesID::Md)] = std::move(speciesAttribute("Md", 258));
	speciesTable[static_cast<int>(SpeciesID::No)] = std::move(speciesAttribute("No", 259.0));
	speciesTable[static_cast<int>(SpeciesID::Lr)] = std::move(speciesAttribute("Lr", 262.0));
	speciesTable[static_cast<int>(SpeciesID::Rf)] = std::move(speciesAttribute("Rf", 261.0));
	speciesTable[static_cast<int>(SpeciesID::Db)] = std::move(speciesAttribute("Db", 262.0));
	speciesTable[static_cast<int>(SpeciesID::Sg)] = std::move(speciesAttribute("Sg", 266.0));
	speciesTable[static_cast<int>(SpeciesID::Bh)] = std::move(speciesAttribute("Bh", 264.0));
	speciesTable[static_cast<int>(SpeciesID::Hs)] = std::move(speciesAttribute("Hs", 277.0));
	speciesTable[static_cast<int>(SpeciesID::Mt)] = std::move(speciesAttribute("Mt", 268.0));
	speciesTable[static_cast<int>(SpeciesID::Ds)] = std::move(speciesAttribute("Ds", 281.0));
	speciesTable[static_cast<int>(SpeciesID::Rg)] = std::move(speciesAttribute("Rg", 272.0));
	speciesTable[static_cast<int>(SpeciesID::Cn)] = std::move(speciesAttribute("Cn", 285.0));
	speciesTable[static_cast<int>(SpeciesID::Uut)] = std::move(speciesAttribute("Uut", 286.0));
	speciesTable[static_cast<int>(SpeciesID::Fl)] = std::move(speciesAttribute("Fl", 289.0));
	speciesTable[static_cast<int>(SpeciesID::Uup)] = std::move(speciesAttribute("Uup", 288.0));
	speciesTable[static_cast<int>(SpeciesID::Lv)] = std::move(speciesAttribute("Lv", 292.0));
	speciesTable[static_cast<int>(SpeciesID::Uus)] = std::move(speciesAttribute("Uus", 294.0));
	speciesTable[static_cast<int>(SpeciesID::Uuo)] = std::move(speciesAttribute("Uuo", 294.0));
	...
	speciesTable[static_cast<int>(SpeciesID::unknown)] = std::move(speciesAttribute());
}
...
{
	return (index < getNumberOfSpecies() && index > -1) ? speciesTable[index].name : std::string("unknown");
}

inline std::string species::getSpeciesName(SpeciesID const index) { return getSpeciesName(static_cast<int>(index)); }

inline SpeciesID species::getSpeciesID(std::string const &SpeciesName)
{
	umuq::parser p;
	auto speciesName = (SpeciesName.size() < 4) ? p.toupper(p.tolower(SpeciesName), 0, 1) : p.tolower(SpeciesName);
	auto search = speciesMap.find(speciesName);
	return (search != speciesMap.end()) ? search->second : SpeciesID::unknown;
}

inline int species::getSpeciesIndex(std::string const &SpeciesName)
{
	return static_cast<int>(getSpeciesID(SpeciesName));
}

inline speciesAttribute species::getSpecies(int const index)
{
	return (index < getNumberOfSpecies() && index > -1) ? speciesTable[index] : speciesTable[static_cast<int>(SpeciesID::unknown)];
}

inline speciesAttribute species::getSpecies(SpeciesID const ID)
{
	return getSpecies(static_cast<int>(ID));
}

inline speciesAttribute species::getSpecies(std::string const &SpeciesName)
{
