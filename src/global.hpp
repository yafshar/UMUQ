...
/*! \mainpage University of Michigan's Uncertainty Quantification (%UMUQ) framework!
 * 
 * **Welcome to %UMUQ!**
 *
 * \section intro_sec Introduction
 * 
 * This is an initial release of %UMUQ source program.
 * 
 * Purpose :
 * 
 * <table>
 ...
 * Contact us
 * ------------
 * If something is not working as you think it should or would like it to, please get in touch with us!<br> 
 * Further, if you have an algorithm or any idea that you would want to try using the UMUQ, please get in touch with us, we would be glad to help!
 * 
 * [Join the chat](https://gitter.im/UMUQ)
 * 
 * Contributors
 * ------------
