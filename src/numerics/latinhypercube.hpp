...
class latinHypercube
{
  public:
																	...
																	n0(0)
	{
		...
		if (dimension == 0)
		{
			UMUQFAIL("Dimension of sequence is 0! \n Wrong Dimension!");
		}
	...
	void check_next_dim()
	{
		...
		{
			UMUQWARNING("Not examined the whole vector!");
		}
	}
	...
	T get_next_dim()
	{
		...
		{
			UMUQFAIL("Dimension out of range!");
		}
		return X[next_dim++];
	}
