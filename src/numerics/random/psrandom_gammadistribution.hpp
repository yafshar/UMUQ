 ...
 * 
 * \brief Generates random positive values x, distributed according to probability density function \f$ \frac{1}{\Gamma (\alpha) \beta^\alpha}x^{\alpha-1}e^{\frac{-x}{\beta}}.\f$ <br>
...
class gammaDistribution
{
  public:
    ...
    /*!
     * \brief Random numbers x according to probability density function \f$ \lambda e^{-\lambda x} \f$ <br>
     * The result type generated by the generator is undefined if T is not one of float, 
     * double, or long double.
     * 
     * \returns Random numbers x according to probability density function \f$ \lambda e^{-\lambda x} \f$ 
     * 
     */
    inline T operator()();
