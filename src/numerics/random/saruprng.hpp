...
class Saru
{
  public:
     ...
     * \param other Saru object
     * 
     * \returns Saru>& dcpse object
     */
	Saru &operator=(Saru &&other);
  ...
  private:
	...
	/*! 
     * Compute A*B mod m.  Tricky only because of implicit \f$ 2^32 \f$ modulus.
     * Uses recursion.
     * 
     * \verbatim
