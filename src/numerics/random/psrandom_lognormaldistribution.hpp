...
class lognormalDistribution
{
  public:
     ...
     * 
     * \param other  Input lognormalDistribution object
     * \returns lognormalDistribution& 
     */
    lognormalDistribution<T> &operator=(lognormalDistribution<T> &&other);

    /*!
     * \brief Random numbers x according to Normal (or Gaussian) random number distribution. <br>
 ...
 * double, or long double
 * 
 * \returns Random random number \f$ x > 0 \f$ according to the lognormal_distribution
 * 
 */
template <typename T>
inline T logNormalDistribution<T>::operator()()
