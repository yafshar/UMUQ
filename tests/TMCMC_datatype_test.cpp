...
TEST(datatype, HandlesIO)
{
    ...
    EXPECT_EQ(1e-12, d1.options.Tol);
    EXPECT_EQ(1, d1.options.Display);
    EXPECT_EQ(1e-4, d1.options.Step);

    EXPECT_EQ(0.05, d1.lowerbound[0]);
    EXPECT_EQ(3.0, d1.lowerbound[1]);
    EXPECT_EQ(6.01, d1.lowerbound[2]);
    EXPECT_EQ(0.0001, d1.lowerbound[3]);
    EXPECT_EQ(10.0, d1.upperbound[0]);
    EXPECT_EQ(4.0, d1.upperbound[1]);
