...
TEST(dcpse_1d, HandlesQianFunction)
{
...

    {
        ...
        if (WRITE_TO_FILE)
        {
            ...
            if (file.openFile("./data/QIAN_TRAIN", file.in | file.out | file.trunc))
            {
            ...
            // Open a file for reading and writing
            if (file.openFile("./data/QIAN_DCPSE_2", file.in | file.out | file.trunc))
            {
                // Write the matrix in it
            ...
            // Open a file for reading and writing
            if (file.openFile("./data/QIAN_EXACT", file.in | file.out | file.trunc))
            {
                // Write the matrix in it
...

    {
        ...
        if (WRITE_TO_FILE)
        {
            ...
            // Open a file for reading and writing
            if (file.openFile("./data/QIAN_DCPSE_3", file.in | file.out | file.trunc))
            {
                // Write the matrix in it
                file.saveMatrix<double>(queryPoints, numDimensions, queryFuncationValues, 1, numQueryPoints);
                file.closeFile();
...
TEST(dcpse_1d, HandlesCFDResults)
{
...

    {
        ...
        if (WRITE_TO_FILE)
        {
            ...
            // Open a file for reading and writing
            if (file.openFile("./data/CFD_TRAIN", file.in | file.out | file.trunc))
            {
                // Write the matrix in it
                file.saveMatrix<double>(dataPoints, numDimensions, dataFuncationValues, 1, numDataPoints);
                file.closeFile();
            ...
            // Open a file for reading and writing
            if (file.openFile("./data/CFD_DCPSE_2", file.in | file.out | file.trunc))
            {
                // Write the matrix in it
                file.saveMatrix<double>(queryPoints, numDimensions, queryFuncationValues, 1, numQueryPoints);
                file.closeFile();
            ...
            // Open a file for reading and writing
            if (file.openFile("./data/CFD_KRIGING", file.in | file.out | file.trunc))
            {
                // Write the matrix in it
                file.saveMatrix<double>(queryPoints, numDimensions, queryFuncationValues, 1, numQueryPoints);
                file.closeFile();
...

    {
        ...
        if (WRITE_TO_FILE)
        {
            ...
            // Open a file for reading and writing
            if (file.openFile("./data/CFD_DCPSE_3", file.in | file.out | file.trunc))
            {
                // Write the matrix in it
                file.saveMatrix<double>(queryPoints, numDimensions, queryFuncationValues, 1, numQueryPoints);
                file.closeFile();
...
TEST(dcpse_2d, HandlesPeaksFunction)
{
...

    {
        ...
        if (WRITE_TO_FILE)
        {
            ...
            // Open a file for reading and writing
            if (file.openFile("./data/PEAKS_TRAIN", file.in | file.out | file.trunc))
            {
                // Write the matrix in it
                file.saveMatrix<double>(dataPoints, numDimensions, dataFuncationValues, 1, numDataPoints);
                file.closeFile();
            ...
            // Open a file for reading and writing
            if (file.openFile("./data/PEAKS_DCPSE_2", file.in | file.out | file.trunc))
            {
                // Write the matrix in it
                file.saveMatrix<double>(queryPoints, numDimensions, queryFuncationValues, 1, numQueryPoints);
                file.closeFile();
            ...
            // Open a file for reading and writing
            if (file.openFile("./data/PEAKS_EXACT", file.in | file.out | file.trunc))
            {
                // Write the matrix in it
                file.saveMatrix<double>(queryPoints, numDimensions, exactQueryFuncationValues, 1, numQueryPoints);
                file.closeFile();
...

    {
        ...
        if (WRITE_TO_FILE)
        {
            ...
            // Open a file for reading and writing
            if (file.openFile("./data/PEAKS_DCPSE_3", file.in | file.out | file.trunc))
            {
                // Write the matrix in it
                file.saveMatrix<double>(queryPoints, numDimensions, queryFuncationValues, 1, numQueryPoints);
                file.closeFile();
...
TEST(dcpse_2d, HandlesPeaksRndFunction)
{
...

    {
        ...
        if (WRITE_TO_FILE)
        {
            ...
            // Open a file for reading and writing
            if (file.openFile("./data/PEAKS_RND_TRAIN", file.in | file.out | file.trunc))
            {
                // Write the matrix in it
                file.saveMatrix<double>(dataPoints, numDimensions, dataFuncationValues, 1, numDataPoints);
                file.closeFile();
            ...
            // Open a file for reading and writing
            if (file.openFile("./data/PEAKS_RND_DCPSE_2", file.in | file.out | file.trunc))
            {
                // Write the matrix in it
                file.saveMatrix<double>(queryPoints, numDimensions, queryFuncationValues, 1, numQueryPoints);
                file.closeFile();
            ...
            // Open a file for reading and writing
            if (file.openFile("./data/PEAKS_RND_EXACT", file.in | file.out | file.trunc))
            {
                // Write the matrix in it
                file.saveMatrix<double>(queryPoints, numDimensions, exactQueryFuncationValues, 1, numQueryPoints);
                file.closeFile();
...

    {
        ...
        if (WRITE_TO_FILE)
        {
            ...
            // Open a file for reading and writing
            if (file.openFile("./data/PEAKS_RND_DCPSE_3", file.in | file.out | file.trunc))
            {
                // Write the matrix in it
                file.saveMatrix<double>(queryPoints, numDimensions, queryFuncationValues, 1, numQueryPoints);
                file.closeFile();
...
TEST(dcpse_2d, HandlesFrankFunction)
{
...

    {
        ...
        if (WRITE_TO_FILE)
        {
            ...
            // Open a file for reading and writing
            if (file.openFile("./data/FRANKS2D_TRAIN", file.in | file.out | file.trunc))
            {
                // Write the matrix in it
                file.saveMatrix<double>(dataPoints, numDimensions, dataFuncationValues, 1, numDataPoints);
                file.closeFile();
            ...
            // Open a file for reading and writing
            if (file.openFile("./data/FRANKS2D_DCPSE_2", file.in | file.out | file.trunc))
            {
                // Write the matrix in it
                file.saveMatrix<double>(queryPoints, numDimensions, queryFuncationValues, 1, numQueryPoints);
                file.closeFile();
            ...
            // Open a file for reading and writing
            if (file.openFile("./data/FRANKS2D_EXACT", file.in | file.out | file.trunc))
            {
                // Write the matrix in it
                file.saveMatrix<double>(queryPoints, numDimensions, exactQueryFuncationValues, 1, numQueryPoints);
                file.closeFile();
...

    {
        ...
        if (WRITE_TO_FILE)
        {
            ...
            // Open a file for reading and writing
            if (file.openFile("./data/FRANKS2D_DCPSE_3", file.in | file.out | file.trunc))
            {
                // Write the matrix in it
                file.saveMatrix<double>(queryPoints, numDimensions, queryFuncationValues, 1, numQueryPoints);
                file.closeFile();
...
TEST(dcpse_2d, HandlesFrankRndFunction)
{
...

    {
        ...
        if (WRITE_TO_FILE)
        {
            ...
            // Open a file for reading and writing
            if (file.openFile("./data/FRANKS2D_RND_TRAIN", file.in | file.out | file.trunc))
            {
                // Write the matrix in it
                file.saveMatrix<double>(dataPoints, numDimensions, dataFuncationValues, 1, numDataPoints);
                file.closeFile();
            ...
            // Open a file for reading and writing
            if (file.openFile("./data/FRANKS2D_RND_DCPSE_2", file.in | file.out | file.trunc))
            {
                // Write the matrix in it
                file.saveMatrix<double>(queryPoints, numDimensions, queryFuncationValues, 1, numQueryPoints);
                file.closeFile();
            ...
            // Open a file for reading and writing
            if (file.openFile("./data/FRANKS2D_RND_EXACT", file.in | file.out | file.trunc))
            {
                // Write the matrix in it
                file.saveMatrix<double>(queryPoints, numDimensions, exactQueryFuncationValues, 1, numQueryPoints);
                file.closeFile();
...

    {
        ...
        if (WRITE_TO_FILE)
        {
            ...
            // Open a file for reading and writing
            if (file.openFile("./data/FRANKS2D_RND_DCPSE_3", file.in | file.out | file.trunc))
            {
                // Write the matrix in it
                file.saveMatrix<double>(queryPoints, numDimensions, queryFuncationValues, 1, numQueryPoints);
                file.closeFile();
...
TEST(dcpse_2d, HandlesRastriginFunction)
{
...

    {
        ...
        if (WRITE_TO_FILE)
        {
            ...
            // Open a file for reading and writing
            if (file.openFile("./data/RASTRIGIN_TRAIN", file.in | file.out | file.trunc))
            {
                // Write the matrix in it
                file.saveMatrix<double>(dataPoints, numDimensions, dataFuncationValues, 1, numDataPoints);
                file.closeFile();
            ...
            // Open a file for reading and writing
            if (file.openFile("./data/RASTRIGIN_DCPSE_2", file.in | file.out | file.trunc))
            {
                // Write the matrix in it
                file.saveMatrix<double>(queryPoints, numDimensions, queryFuncationValues, 1, numQueryPoints);
                file.closeFile();
            ...
            // Open a file for reading and writing
            if (file.openFile("./data/RASTRIGIN_EXACT", file.in | file.out | file.trunc))
            {
                // Write the matrix in it
                file.saveMatrix<double>(queryPoints, numDimensions, exactQueryFuncationValues, 1, numQueryPoints);
                file.closeFile();
...

    {
        ...
        if (WRITE_TO_FILE)
        {
            ...
            // Open a file for reading and writing
            if (file.openFile("./data/RASTRIGIN_DCPSE_3", file.in | file.out | file.trunc))
            {
                // Write the matrix in it
                file.saveMatrix<double>(queryPoints, numDimensions, queryFuncationValues, 1, numQueryPoints);
                file.closeFile();
